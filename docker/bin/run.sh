...
if [[ "$TARGET" == "jetson" ]]; then
    ...
    docker run -it --rm --net=host --gpus all --runtime nvidia -e DISPLAY=$DISPLAY -v /tmp/.X11-unix/:/tmp/.X11-unix -v ${GIT_WS}:/root/git -v ${CATKIN_WS}:/root/catkin_ws/ $WVN_DESKTOP_TAG
