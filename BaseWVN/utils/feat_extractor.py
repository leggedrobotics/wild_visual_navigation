...
from .visualizer import plot_overlay_image,plot_tsne,add_color_bar_and_save,plot_image,plot_overlay_image_binary
...
def compute_phy_mask(img:torch.Tensor,
    ...
    if plot_and_save:
        ...
        for i in range(channel_num):
            ...
            overlay_img_raw=plot_overlay_image(trans_img, overlay_mask=output_phy_ori, channel=i,alpha=1.0)
